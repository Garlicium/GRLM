...
* Update manpages, see [gen-manpages.sh](https://github.com/Garlicium/GRLM/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [garlicium-detached-sigs](https://github.com/Garlicium/GRLM-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the garlicium.org server.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Garlicium/GRLM/releases/new) with a link to the archived release notes.
